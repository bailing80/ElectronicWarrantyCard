...
// 姓名查重
export function nameDuplicateCheck(params) {
  let nameDupData = {
    "code": 200,
    "msg": null,
    "data": {}
  ...
  let content = this.getContent(pageNum, pageSize)
  nameDupData.data.pageNum = pageNum
  nameDupData.data.pageSize = pageSize
  nameDupData.data.totalSize = 50
  nameDupData.data.content = content
  return {
...
// 手机号查重
export function telDuplicateCheck(params) {
  let telDupData = {
    "code": 200,
    "msg": null,
    "data": {}
  ...
  let content = this.getContent(pageNum, pageSize)
  telDupData.data.pageNum = pageNum
  telDupData.data.pageSize = pageSize
  telDupData.data.totalSize = 50
  telDupData.data.content = content
  return {
