...
<!--           
   ...
   <el-link v-show="!show1" @click="getCode" style="font-family: PingFangSC-Regular;font-size: 16px;color: #854FC1;line-height: 18px;text-align: center;line-height: 24px;right:40px;">点击发送</el-link>
...
line-height: 24px;">产品购买及配置信息（选填）</span>
        ...
        <el-form-item>
          ...
          <!-- <el-link style="right:70px;" type="primary" href="#/cheakdate" target="_blank">根据序列号查询剩余日期</el-link> -->
